...
void experiment(int minLength, int maxLength){
	...
	fprintf(file, "+-----------+-------------------------------+-------------------------------+-------------------------------+-------------------------------+\n");
        fprintf(file, "| ######### | InsertionSort                 | MergeSort                     | HybridSort                    | QuickSort M3                  |\n");
        fprintf(file, "+-----------+-------------------+-----------+-------------------+-----------+-------------------+-----------+-------------------+-----------+\n");
        fprintf(file, "| Dimension | Time              | isSorted? | Time              | isSorted? | Time              | isSorted? | Time              | isSorted? |\n");
        fprintf(file, "+-----------+-------------------+-----------+-------------------+-----------+-------------------+-----------+-------------------+-----------+\n");
	...
	for(int i = minLength; i < maxLength; i=i+step){
		...
		fprintf(file, "| %9d | %17f | %9s | %17f | %9s | %17f | %9s | %17f | %9s |\n",
                i,
